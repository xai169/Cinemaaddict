...
/* harmony import */ var dayjs_random__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(dayjs_random__WEBPACK_IMPORTED_MODULE_2__);
        ...
        const createComment = () => {
          ...
          return {
            emoji: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(emojis),
            text: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(texts),
            author: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(authorNames),
            date: commentsDate,
          }
        };

        const generateComments = () => {
          return new Array((0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(0, 5)).fill().map(createComment);
...
/* harmony import */ var dayjs_random__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(dayjs_random__WEBPACK_IMPORTED_MODULE_3__);
        ...
        const generateFilmDescription = () => {
          const description = []
          for (let i = 0; i < (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(1, 5); i++) {
            description.push((0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(descriptions));
          }
        ...
        const generateFilmWorkers = (workersGroup) => {
          const workers = []
          for (let i = 0; i < 3; i++) {
            workers.push((0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(workersGroup));
          }
          return workers.join(',');
        }
        ...
        const generateGenres = () => {
          const filmGenres = []
          for (let i = 0; i < 3; i++) {
            filmGenres.push((0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(genres));
          }
          return filmGenres;
        }
        ...
        const generateFilmCard = () => {
          ...
          return {
            poster: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(posters),
            title: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(titles),
            raiting: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandom)(0, 10).toFixed(1),
            releaseDate: date,
            ...
            filter: {
              isFavorite: Boolean((0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(0, 1)),
              isWatched: Boolean((0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(0, 1)),
              isWatchList: Boolean((0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(0, 1)),
            },
            director: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(directors),
            writers: generateFilmDescription(writers),
            actors: generateFilmWorkers(actors),
            country: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(countries),
            ageRaiting: (0, _util_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(ageRaitings),
          }
        }
    ...
    <p class="film-details__comment-info">
      ...
      <button class="film-details__comment-delete">Delete</button>
        ...
        class Comments {
          ...
          getElement() {
            if (!this._element) {
              this._element = (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_0__.createElement)(this.getTemplate());
            }
...
/* harmony import */ var _mock_util_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./mock/util.js */ "./src/mock/util.js");
    ...
    const renderFilmCard = (filmCardListElement, filmCard) => {
      ...
      const onEscKeyDown = (evt) => {
        if ((0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.checkEsc)(evt)) {
          closePopup();
        }
      };
      ...
      const showPopup = () => {
        ...
        for (let i = 0; i < filmCard.comments.length; i++) {
          (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(commentsList, new _view_comment_js__WEBPACK_IMPORTED_MODULE_12__["default"](filmCard.comments[i]).getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
        }
      ...
      (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(filmCardListElement, filmComponent.getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND)
    };

    (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(siteMainElement, new _view_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters).getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
    (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(filmFooterStatistic, new _view_films_count_js__WEBPACK_IMPORTED_MODULE_9__["default"](filmCards).getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);

    //Проверка наличия фильмов
    if (filmCards.length === 0) {
      (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(siteMainElement, new _view_empty_film_list_js__WEBPACK_IMPORTED_MODULE_13__["default"]().getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
    } else {
      (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(siteHeaderElement, new _view_user_rank_js__WEBPACK_IMPORTED_MODULE_8__["default"](filters).getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
      const filmSectionComponent = new _view_film_section_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
      (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(siteMainElement, filmSectionComponent.getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
      const filmListComponent = new _view_film_list_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
      (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(filmSectionComponent.getElement(), filmListComponent.getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
      ...
      (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(filmSectionComponent.getElement(), mostCommentedFilmsComponent.getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
      const mostCommentedList = mostCommentedFilmsComponent.getElement().querySelector('.films-list__container');
      const mostCommentedFilms = filmCards.slice().sort(_mock_util_js__WEBPACK_IMPORTED_MODULE_14__.compareCommentsNumber);
      ...
      (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(filmSectionComponent.getElement(), TopRatedFilmsComponent.getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
      const topRatedList = TopRatedFilmsComponent.getElement().querySelector('.films-list__container');
      const topRatedFilms = filmCards.slice().sort(_mock_util_js__WEBPACK_IMPORTED_MODULE_14__.compareFilmRaiting);
      for (let i = 0; i < EXTRA_FILMS_COUNT; i++) {
        renderFilmCard(topRatedList, topRatedFilms[i]);
      }

      //Отрисовка Show More Button
      (0, _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.render)(filmListComponent.getElement(), new _view_showmore_button_js__WEBPACK_IMPORTED_MODULE_5__["default"]().getElement(), _mock_util_js__WEBPACK_IMPORTED_MODULE_14__.RenderPosition.BEFOREEND);
